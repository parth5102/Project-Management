		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="card">
					...
					<%-- 	<%
							List<ModuleBean> moduleBean = (List<ModuleBean>) request.getAttribute("moduleBean");
						%> --%>
						<form action="savemoduleimage" method="post" enctype="multipart/form-data" >
							...
							<div class="row mb-3">
								...
								<div class="col-2">
									<a class="btn btn-danger w-100" href="listmodule"
