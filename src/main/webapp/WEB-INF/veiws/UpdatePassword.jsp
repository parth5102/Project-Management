          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="updatemypassword" class="logo d-flex align-items-center w-auto">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="updatemypassword" method="post">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Update My Password</button>
                    </div>
